...
\newcommand{\pmclustversion}{0.1-6}
...
\Plaintitle{Quick Guide for pmclust (Ver. \pmclustversion)} %% without formatting
\Shorttitle{Quick Guide for pmclust (Ver. \pmclustversion)} %% a short title (if necessary)
